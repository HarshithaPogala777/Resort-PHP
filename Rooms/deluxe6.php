...
.socials a {
    ...
    .rowfooterSection{
        background-color: rgb(18, 11, 100);
        color: white;
    }
    .rectangle1 {
      display: inline-block;
...
<img src = "deluxe6.jpg"width="1350px" height="500px"><br><br>
<h2 align="center">STUDIO ROOM</h2><br><br>
<div class="container">
  <div class="row">
    ...
    <div class="col"><br><br><br><br>
      <a style="color: maroon;"><h5><s><b>&#x20B9;7,000</b></s></h5>
        ...
        <div class="checkmark">&#10004; <b>No Prepayment required</b></div>
